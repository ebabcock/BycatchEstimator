...
# plot unstratified ratio estimator?
...
print(ggplot(yearSumLong,aes(x=Year,y=Mean,ymin=Mean-1.96*SE,ymax=Mean+1.96*SE,color=Method,fill=Method))+
  geom_line()+
  geom_point()+
  geom_ribbon(alpha=0.5))
cat("\n Figure ", figurenum, ". Design-based bycatch estimates per year with 95% confidence intervals.",sep = "")
